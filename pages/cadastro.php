...
try {
    if(isset($_POST['salvar'])) {
        $nome = $_POST['nome'];
        $cpf = $_POST['cpf'];
        $data_usuario = $_POST['data_nascimento']; // data do usuário no formato dd/MM/yyyy
        ...
        // Inserção segura com parâmetros
        $stmt = $conectar->prepare("
            INSERT INTO aluno (nome, cpf, data_nascimento, endereco, email, telefone)
            VALUES (:nome, :cpf, :data_nascimento, :endereco, :email, :telefone)
        ");
        ...
        if($stmt->execute()) {
            // Redireciona para home.php após cadastro
    ...
    <div class="FormEditar">
        <div class="quadradoEditar">
            ...
            <form method="POST" action="">
                <h1 id="TituloEditar">Cadastro</h1>
                <hr />
